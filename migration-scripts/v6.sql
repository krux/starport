create table "pipeline_dependencies" ("pipeline_id" INTEGER NOT NULL,"upstream_pipeline_id" INTEGER NOT NULL);

alter table "pipeline_dependencies" add constraint "pipeline_dependencies_pipelines_dependency_fk" foreign key("upstream_pipeline_id") references "pipelines"("id") on update RESTRICT on delete CASCADE;
